...
func (h *GuestMessageHandler) CreateOrganization(w http.ResponseWriter, r *http.Request) {
...
func (h *GuestMessageHandler) GetOrganizationPagination(w http.ResponseWriter, r *http.Request) {
